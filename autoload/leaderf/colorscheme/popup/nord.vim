if &background ==? 'dark'
    ...
    highlight def Lf_hl_popup_inputText guifg=#eceff4 guibg=#4c566a gui=NONE ctermfg=117 ctermbg=239 cterm=NONE

    " Lf_hl_popup_window is the wincolor of content window
    highlight def Lf_hl_popup_window guifg=#eeeeee guibg=#2e3440 gui=NONE ctermfg=255 ctermbg=237 cterm=NONE

    " Lf_hl_popup_blank is the wincolor of statusline window
    highlight def Lf_hl_popup_blank guifg=NONE guibg=#434c5e gui=NONE ctermbg=239 cterm=NONE
    ...
    highlight def Lf_hl_popup_normalMode guifg=#4c566a guibg=#c1ce96 gui=bold ctermfg=58 ctermbg=187 cterm=bold
    highlight def Lf_hl_popup_inputMode guifg=#003333 guibg=#98b3a5 gui=bold ctermfg=23 ctermbg=109 cterm=bold
    highlight def Lf_hl_popup_category guifg=#ecebf0 guibg=#3b4252 gui=NONE ctermfg=255 ctermbg=241 cterm=NONE
    highlight def Lf_hl_popup_nameOnlyMode guifg=#4c566a guibg=#cbb370 gui=NONE ctermfg=234 ctermbg=179 cterm=NONE
    highlight def Lf_hl_popup_fullPathMode guifg=#4c566a guibg=#aab3b6 gui=NONE ctermfg=234 ctermbg=249 cterm=NONE
    highlight def Lf_hl_popup_fuzzyMode guifg=#4c566a guibg=#aab3b6 gui=NONE ctermfg=234 ctermbg=249 cterm=NONE
    highlight def Lf_hl_popup_regexMode guifg=#4c566a guibg=#a0b688 gui=NONE ctermfg=234 ctermbg=108 cterm=NONE
    highlight def Lf_hl_popup_cwd guifg=#d08770 guibg=#3b4252 gui=NONE ctermfg=230 ctermbg=243 cterm=NONE
    highlight def Lf_hl_popup_lineInfo guifg=#434c5e guibg=#dce6da gui=NONE ctermfg=236 ctermbg=254 cterm=NONE
    highlight def Lf_hl_popup_total guifg=#434c5e guibg=#b8ccbb gui=NONE ctermfg=236 ctermbg=151 cterm=NONE


    " the color of the cursorline
    highlight def Lf_hl_cursorline guifg=#ebcb8b guibg=NONE gui=NONE ctermfg=226 ctermbg=NONE cterm=NONE

    " the color of matching character
    highlight def Lf_hl_match  guifg=#a3be8c guibg=NONE gui=bold ctermfg=85 ctermbg=NONE cterm=bold

    " the color of matching character in `And mode`
    highlight def Lf_hl_match0 guifg=#a3be8c guibg=NONE gui=bold ctermfg=85 ctermbg=NONE cterm=bold
    ...
    highlight def Lf_hl_selection guifg=#434c5e guibg=#a5eb84 gui=NONE ctermfg=Black ctermbg=156 cterm=NONE
