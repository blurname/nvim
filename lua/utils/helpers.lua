...
---Blend color fg with color bg. E.g., blend(fg, 0.2, bg) will blend 80% fg with 20% bg.
...
---background). E.g., hl2ansi('Special', 'fg', 'fg') will convert the foreground of Special to ANSI
---foreground color.
